...
const RequestPostsPage = () => {
  ...
  return (
    <AdminLayout page="request-posts">
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white p-6 relative top-0 h-fit w-96">
            ...
            <p className="my-8">
              ...
              {formData.approve === "approved" ? (
                <span className="text-green-600 font-bold">Approve</span>
              ) : (
                <span className="text-red-600 font-bold">Unapprove</span>
              )}{" "}
              this post "{selectedPost?.title}"?
            </p>
...
export default RequestPostsPage;
